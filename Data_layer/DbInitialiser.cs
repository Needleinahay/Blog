...
namespace Blog
{
    ...
    public class DbInitialiser : DropCreateDatabaseAlways<BlogDbContext>
    {
        protected override void Seed(BlogDbContext db)
        {
            ...
            db.Comments.Add(first);
            db.Comments.Add(second);
            TopicComment comm1 = new TopicComment {  Comment = first };
            TopicComment comm2 = new TopicComment {  Comment = second };
            db.CommentsOnTopic.Add(comm1);
            db.CommentsOnTopic.Add(comm2);
            db.Comments.Add(new Comment { CommentId = 1, CommentText = "This is my point on stuff", AuthorName = "Vanya", PostedDate = DateTime.Now});
            db.Comments.Add(new Comment { CommentId = 2, CommentText = "Nothing valuable...", AuthorName = "Sergey", PostedDate = DateTime.Now});
